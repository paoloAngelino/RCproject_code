...
class rcFolds:
    ...
    def __init__(self, rc_data, folds_count=5):
        """
        ...
        self.X = rc_data.x_train  # Assumed to be a DataFrame
        self.y = rc_data.y_train  # Assumed to be a DataFrame

        # Use a specific column from y for stratification
        self.y_stratify = self.y['combination_tech_outcome']  # Ensure this column exists
        ...
        self.genes_list = self.rc_data.genes_list
    ...
    def get_folds(self):
        ...
        for train_index, test_index in skf.split(self.X, self.y_stratify):
            ...
            self.y_train_folds.append(self.y.iloc[train_index])
            self.y_test_folds.append(self.y.iloc[test_index])
