...
class PredCnnModelAttention:
    ...
    def build_outcome_classifier_with_attention(self):
        """
        CNN model for gene expression data (bulk RNA-seq) with attention mechanism.
        """
        self.outcome_classifier = models.Sequential()
        ...
        # Attention mechanism
        self.outcome_classifier.add(layers.MultiHeadAttention(num_heads=4, key_dim=32))
