...
em_down <- enricher(DE_DOWN, minGSSize = 5, maxGSSize = 100, TERM2GENE=t2g, pvalueCutoff = 0.05, qvalueCutoff = 1, pAdjustMethod = "none")
```
...
p
ggsave(
      filename = paste0("GSEADotplot_PVAL.pdf"), 
      plot = p, path =  params$plot.dir
    )
```
...
p
ggsave(
      filename = paste0("GSEADotplot_LOGFC.pdf"), 
      plot = p, path =  params$plot.dir,
      width = 14, height = 9
    )
```
